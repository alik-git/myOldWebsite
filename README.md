...
This is the repo for my personal website. I use the [al-folio](https://github.com/alshedivat/al-folio) theme that uses [Jekyll](https://jekyllrb.com/) and [Github Pages](https://pages.github.com/). 
